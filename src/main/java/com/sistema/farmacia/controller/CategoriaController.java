...
import com.sistema.farmacia.model.Categoria;
import com.sistema.farmacia.repository.CategoriaRepository;
...
public class CategoriaController {
	...
	public void delete(@PathVariable Long id) {
		java.util.Optional<Categoria> tema = repository.findById(id);
